<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmdispsgs.aspx.cs" Inherits="frmdispsgs" %>
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
                ...
                <li ><a href="Default.aspx">Home</a></li>
                    ...
                    <li><a href="Default.aspx">Latest News</a></li>
                     ...
                     <li><a href="Default.aspx">Contact</a></li>
                      ...
                      <li class="current"><a href="frmdisp_video.aspx">Videos</a></li>
                    <li><a href="frmdwnld.aspx">Downlods</a></li>  </ul>
            </nav>
        </div>
	...
	<div class="page-wrap container">
			<div class="grid-9">
                ...
                <asp:DataList ID="DataList3" runat="server" OnItemCommand="DataList3_ItemCommand1">
                     <ItemTemplate>
                          <article>
					...
					<h3><%# Eval("sgstitle") %></h3>
					<p><%# Eval("sgsdesc") %> </p>
                              <asp:LinkButton ID="LinkButton3" runat="server" cssclass="s-btn"  CommandArgument='<%#Eval("sgsid") %>' CommandName="abc1" >Download</asp:LinkButton>
